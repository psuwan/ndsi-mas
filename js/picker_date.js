function picker_date(element, option) {
    ...
    var render_cal_pic = function (element, month, year) {
        ...
        html += "<button class='btn btn-sm btn-danger clear_cal_btn' >";
        html += "<i class='fa fa-times' ></i>&nbsp;&nbsp;ปิดปฏิทิน";
        html += "</button>";
    ...
    $("[data-picker=" + ran_cal_id + "]").on("click", function () {
        ...
        $(month_select).addClass("form-control-sm");
        ...
        $(month_select).append("<option value='05' >พฤกษภาคม</option>");
        ...
        $(year_select).addClass("form-control-sm");
        ...
        $(left_btn).addClass("btn-outline-secondary");
        ...
        $(right_btn).addClass("btn-outline-secondary");
