// Upload files
function uploadCmdFiles(name2Up, dir2Up, fileRet) {
    // console.log(name2Up);
    // console.log(dir2Up);
    // console.log(fileRet);

    let totalfiles = document.getElementById("id4CmdFiles_" + name2Up).files.length;
    ...
    if (totalfiles > 0) {
        ...
        for (let index = 0; index < totalfiles; index++) {
            formData.append('cmdFiles_' + name2Up + '[]', document.getElementById("id4CmdFiles_" + name2Up).files[index]);
        }
        ...
        xhttp.open("POST", "uploadFilesCmd.php", true);
