        ...
        <div class="row mt-3">
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 d-flex justify-content-center">
                ...
                <div class="card shadow-lg" style="width: 100%;">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2 text-muted"><?= $mil2View; ?></h6>
                        <div class="row">
...
<!--                                <div class="col-12">-->
<!--                                    <a href="./userProfileAct.php?command=want2Up&milNumber=--><?//=$mil2View;?><!--" class="btn btn-sm btn-outline-primary">ต้องการรับการประเมินวิทยฐานะ</a>-->
<!--                                </div>-->
<!--                            </div>-->
                            <!-- Row #00 -->
                            ...
                            <input type="hidden" name="milNum2Update" value="<?= $mil2View; ?>">
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 d-flex justify-content-center">
                <div class="card shadow-lg" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <?php
                        $cntData = countDB('mas_userschool', 'mil_number', $mil2View, 2);
                        if ($cntData > '0') {
                            ?>
                            <div class="row mt-3">
...
<!--                                            <th></th>-->
                                        ...
                                        <tbody>
                                        <?php
                                        $sqlcmd_listStudyData = "SELECT * FROM mas_userschool WHERE mil_number='" . $mil2View . "' ORDER BY school_level ASC, school_year ASC";
            ...
            <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 d-flex justify-content-center">
                <div class="card shadow-lg" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <?php
                        $cntData = countDB('mas_milcourse', 'mil_number', $mil2View, 2);
                        if ($cntData > '0') {
                            ?>
                            <div class="row mt-3">
                                <div class="col-12 table-responsive">
...
<!--                                            <th></th>-->
                                        ...
                                        <tbody>
                                        <?php
                                        $sqlcmd_listCourse = "SELECT * FROM mas_milcourse WHERE mil_number='" . $mil2View . "'";
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="./userStudyAct.php" method="post">
                ...
                <input type="hidden" name="milNumber" value="<?= $mil2View; ?>">
            </form>
        </div>
    </div>
</div><!-- Modal for study -->
